...
import StatelessLabsText from "../StatelessLabsText/StatelessLabsText.jsx";

const StatelessLabsLogoVar2 = (props) => {
        ...
        if (gParentRef.current) {
            ...
            const checkAngle = async () => {
                ...
                if (targetAngles.has(roundedAngle)) {
                    ...
                    if (roundedAngle === 15 || roundedAngle === 195) {
                        await Promise.all([
                            animateHc5(scopeHc5.current, {
                    ...
                    if (roundedAngle === 75 || roundedAngle === 255) {
                        await Promise.all([
                            animateHc4(scopeHc4.current, {
                                    filter: ['brightness(1.5)']
                                },
                    ...
                    if (roundedAngle === 135 || roundedAngle === 315) {
                        await Promise.all([
                            animateHc6(scopeHc6.current, {
                                    filter: ['brightness(1.5)']
                                },
...
export default StatelessLabsLogoVar2;
